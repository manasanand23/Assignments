...
\item  One says, "Give me a hundred, Friend!  I shall then become twice as rich as you". The other "if you give me ten, i shall be six times as rich as you".  Tell me What is the amount of their (respective) capital?[From the bijaganita of bhaskara II] 
...
\item In a $\triangle ABC", <C=3 <B=2(<A+<B)$. Find the three angles
...
\end{align}
\end{enumerate}
\item $ABCD$ is a cyclic quadrilateral [see Fig $3.7$]. Find the angles of the cyclic quadrilateral.
\begin{figure}[ht]
\centering
